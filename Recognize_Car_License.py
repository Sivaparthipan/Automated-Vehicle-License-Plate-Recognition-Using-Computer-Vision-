...
def segment_chars(plate_img, fixed_width):
    """Extract Value channel from the HSV format of image and apply adaptive thresholding to reveal the characters on the license plate"""
...
class OCR:
    ...
    def convert_tensor(self, image, imageSizeOuput):
        """Takes an image and transform it into a tensor"""
...
if __name__ == "__main__":
    ...
    model = OCR(modelFile=model_file, labelFile=label_file)
